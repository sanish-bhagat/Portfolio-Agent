...
const MinimalPortfolio = ({ portfolioData, visibleSections = [] }: Props) => {
      ...
      {isVisible('hero') && (
        <section className="min-h-[85vh] flex flex-col justify-center px-6 md:px-12">
          <div className="max-w-[720px] mx-auto w-full">
            ...
            <p className="text-lg md:text-xl text-minimal-muted-fg leading-relaxed mb-10 max-w-lg">{hero.tagline}</p>
        ...
        <>
          ...
          <section id="contact" className="py-20 md:py-28 px-6 md:px-12">
            <div className="max-w-[720px] mx-auto">
              ...
              <div className="flex flex-col gap-3 mb-8 text-minimal-muted-fg">
                {contact_section.phone && (
                  <a href={`tel:${contact_section.phone}`} className="flex items-center gap-3 hover:text-minimal-fg transition-colors">
                    <Phone className="w-4 h-4" />
                    <span className="text-sm">{contact_section.phone}</span>
                  </a>
                )}
                {contact_section.location && (
                  <div className="flex items-center gap-3">
                    <MapPin className="w-4 h-4" />
                    <span className="text-sm">{contact_section.location}</span>
                  </div>
                )}
              </div>
