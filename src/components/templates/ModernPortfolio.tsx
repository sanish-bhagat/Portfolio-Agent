...
const ModernPortfolio = ({ portfolioData, visibleSections = [] }: Props) => {
      ...
      {isVisible('contact') && (
        <section id="contact" className="py-20 md:py-28 px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-8 text-modern-muted-fg">
              {contact_section.phone && (
                <a href={`tel:${contact_section.phone}`} className="flex items-center gap-2 hover:text-modern-accent transition-colors">
                  <Phone className="w-4 h-4 text-modern-accent" />
                  <span>{contact_section.phone}</span>
                </a>
              )}
              {contact_section.location && (
                <div className="flex items-center gap-2">
                  <MapPin className="w-4 h-4 text-modern-accent" />
